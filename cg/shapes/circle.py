...
def draw_circle(canvas_width=500, canvas_height=500, canvas_bg="#ffffff", fill="#ffffff", outline="#E93B81",
                square_width=5):
    root = Tk()
    root.title('Circle')
    ...
    canvas.create_oval(small_side / 8, small_side / 8, small_side / 1.15, small_side / 1.15, fill=fill,
                            outline=outline,
                            width=square_width)
    canvas.pack()
    root.mainloop()
