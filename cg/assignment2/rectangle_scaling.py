...
def rectangle_scaling(canvas, start, end, translation_factor):
    ...
    new_coordinates = Transformation.rotate((start[0], start[1], end[0], end[1]), translation_factor)
    draw_rectangle(canvas, new_coordinates[0], new_coordinates[1], new_coordinates[2], new_coordinates[3], color.primary)

if __name__ == "__main__":
    window = Window(rectangle_scaling)
    window.set_title("Rectangle Scaling")
