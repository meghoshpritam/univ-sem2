...
def alphabat_w(canvas_width=500, canvas_height=500, canvas_bg="#ffffff", fill="#ffffff",
               outline="#E93B81", width=5):
    root = Tk()
    root.title('Alphabate - w')
    ...
    canvas.create_line(small_side * 0.5, small_side*0.5,
                       small_side*0.4, small_side*0.8, width=width, fill=outline)
    
    canvas.create_line(small_side * 0.5, small_side*0.5,
                       small_side*0.6, small_side*0.8, width=width, fill=outline)

    canvas.create_line(small_side * 0.7, small_side*0.5,
                       small_side*0.6, small_side*0.8, width=width, fill=outline)
