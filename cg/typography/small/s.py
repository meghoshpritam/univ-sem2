...
def alphabat_s(canvas_width=500, canvas_height=500, canvas_bg="#ffffff", fill="#ffffff",
    ...
    canvas.create_arc(small_side * 0.4, small_side*0.5,
                      small_side*0.6, small_side*0.65, start=20, extent=250, width=width, style="arc", outline=outline)

    canvas.create_arc(small_side * 0.4, small_side*0.65,
                      small_side*0.6, small_side*0.80, start=100, extent=-260, width=width, style="arc", outline=outline)
