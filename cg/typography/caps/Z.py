...
def alphabat_Z(canvas_width=500, canvas_height=500, canvas_bg="#ffffff", fill="#ffffff",
               outline="#E93B81", width=5):
    root = Tk()
    root.title('Alphabate - Z')
    ...
    canvas.create_line(small_side * 0.3, small_side*0.2,
                       small_side*0.7, small_side*0.2, width=width, fill=outline)

    canvas.create_line(small_side * 0.7, small_side*0.2,
